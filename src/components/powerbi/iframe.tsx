...
export default function Iframe ({ props, preloader, page, filters }) {
  ...
  return (
        ...
        {
            loading && (
                <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100vw', height: '100vh', position: 'absolute', left: 0, top: 0, backgroundColor: '#fff' }} >
            ...
            <PowerBIEmbed
                ...
                eventHandlers = {
                    new Map([
                      ...
                      ['rendered', function () { setLoading(false) }],
